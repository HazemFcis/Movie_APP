...
public class FavoriteDbHelper extends SQLiteOpenHelper {
    ...
    public void addFavorite(movies movie){
        ...
        values.put(FavoriteContract.FavoriteEntry.COLUMN_POSTER_PATH, movie.getImage());
    ...
    public List<movies> getAllFavorite(){
        ...
        if (cursor.moveToFirst()){
            do {
                ...
                movie.setRating(cursor.getString(cursor.getColumnIndex(FavoriteContract.FavoriteEntry.COLUMN_USERRATING)));
                movie.setImage(cursor.getString(cursor.getColumnIndex(FavoriteContract.FavoriteEntry.COLUMN_POSTER_PATH)));
    ...
    public boolean Exists(String searchItem) {
        ...
        Cursor cursor = getReadableDatabase().query(FavoriteContract.FavoriteEntry.TABLE_NAME, columns, selection, selectionArgs, null, null, null, limit);
